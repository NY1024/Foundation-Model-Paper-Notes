...
* [Others](others/README.md)
  ...
  * [ArtPrompt: ASCII Art-based Jailbreak Attacks against Aligned LLMs](others/artprompt-ascii-art-based-jailbreak-attacks-against-aligned-llms.md)
  ...
  * [Jailbroken: How Does LLM Safety Training Fail?](others/jailbroken-how-does-llm-safety-training-fail/README.md)
    * [SHADOW ALIGNMENT: THE EASE OF SUBVERTING  SAFELY-ALIGNED LANGUAGE MODELS](others/jailbroken-how-does-llm-safety-training-fail/shadow-alignment-the-ease-of-subverting-safely-aligned-language-models.md)
    * [EVALUATING THE SUSCEPTIBILITY OF PRE-TRAINED LANGUAGE MODELS VIA HANDCRAFTED ADVERSARIAL EXAMPLES](others/jailbroken-how-does-llm-safety-training-fail/evaluating-the-susceptibility-of-pre-trained-language-models-via-handcrafted-adversarial-examples.md)
    * [Defending LLMs against Jailbreaking Attacks via Backtranslation](others/jailbroken-how-does-llm-safety-training-fail/defending-llms-against-jailbreaking-attacks-via-backtranslation.md)
    * [EMULATED DISALIGNMENT: SAFETY ALIGNMENT  FOR LARGE LANGUAGE MODELS MAY BACKFIRE!](others/jailbroken-how-does-llm-safety-training-fail/emulated-disalignment-safety-alignment-for-large-language-models-may-backfire.md)
    * [Untitled](others/jailbroken-how-does-llm-safety-training-fail/untitled.md)
    * [ON THE SAFETY OF OPEN-SOURCED LARGE LAN GUAGE MODELS: DOES ALIGNMENT REALLY PREVENT  THEM FROM BEING](others/jailbroken-how-does-llm-safety-training-fail/on-the-safety-of-open-sourced-large-lan-guage-models-does-alignment-really-prevent-them-from-being.md)
    * [Unveiling the Implicit Toxicity in Large Language Models](others/jailbroken-how-does-llm-safety-training-fail/unveiling-the-implicit-toxicity-in-large-language-models.md)
    * [Forcing Generative Models to Degenerate Ones:  The Power of Data Poisoning Attacks](others/jailbroken-how-does-llm-safety-training-fail/forcing-generative-models-to-degenerate-ones-the-power-of-data-poisoning-attacks.md)
    * [Make Them Spill the Beans!  Coercive Knowledge Extraction from (Production) LLMs](others/jailbroken-how-does-llm-safety-training-fail/make-them-spill-the-beans-coercive-knowledge-extraction-from-production-llms.md)
    * [Learning to Poison Large Language Models During Instruction Tuning](others/jailbroken-how-does-llm-safety-training-fail/learning-to-poison-large-language-models-during-instruction-tuning.md)
    * [ALIGNMENT IS NOT SUFFICIENT TO PREVENT LARGE  LANGUAGE MODELS FROM GENERATING HARMFUL IN FORMATION:](others/jailbroken-how-does-llm-safety-training-fail/alignment-is-not-sufficient-to-prevent-large-language-models-from-generating-harmful-in-formation.md)
    * [LANGUAGE MODEL UNALIGNMENT: PARAMETRIC  RED-TEAMING TO EXPOSE HIDDEN HARMS AND BI ASES](others/jailbroken-how-does-llm-safety-training-fail/language-model-unalignment-parametric-red-teaming-to-expose-hidden-harms-and-bi-ases.md)
    * [Stealthy and Persistent Unalignment on Large Language Models via  Backdoor Injections](others/jailbroken-how-does-llm-safety-training-fail/stealthy-and-persistent-unalignment-on-large-language-models-via-backdoor-injections.md)
    * [IMMUNIZATION AGAINST HARMFUL FINE-TUNING AT TACKS](others/jailbroken-how-does-llm-safety-training-fail/immunization-against-harmful-fine-tuning-at-tacks.md)
    * [EMULATED DISALIGNMENT: SAFETY ALIGNMENT  FOR LARGE LANGUAGE MODELS MAY BACKFIRE!](others/jailbroken-how-does-llm-safety-training-fail/emulated-disalignment-safety-alignment-for-large-language-models-may-backfire-1.md)
    * [Composite Backdoor Attacks Against Large Language Models](others/jailbroken-how-does-llm-safety-training-fail/composite-backdoor-attacks-against-large-language-models.md)
    * [AWolf in Sheep’s Clothing: Generalized Nested Jailbreak Prompts can  Fool Large Language Models Easi](others/jailbroken-how-does-llm-safety-training-fail/awolf-in-sheeps-clothing-generalized-nested-jailbreak-prompts-can-fool-large-language-models-easi.md)
    * [ALL IN HOW YOU ASK FOR IT: SIMPLE BLACK-BOX METHOD FOR JAILBREAK ATTACKS](others/jailbroken-how-does-llm-safety-training-fail/all-in-how-you-ask-for-it-simple-black-box-method-for-jailbreak-attacks.md)
    * [LLMJailbreak Attack versus Defense Techniques- A Comprehensive  Study](others/jailbroken-how-does-llm-safety-training-fail/llmjailbreak-attack-versus-defense-techniques-a-comprehensive-study.md)
    * [Weak-to-Strong Jailbreaking on Large Language Models](others/jailbroken-how-does-llm-safety-training-fail/weak-to-strong-jailbreaking-on-large-language-models.md)
    * [MULTIVERSE: Exposing Large Language Model Alignment Problems in  Diverse Worlds](others/jailbroken-how-does-llm-safety-training-fail/multiverse-exposing-large-language-model-alignment-problems-in-diverse-worlds.md)
    * [Universal and Transferable Adversarial Attacks  on Aligned Language Models](others/jailbroken-how-does-llm-safety-training-fail/universal-and-transferable-adversarial-attacks-on-aligned-language-models.md)
    * [COERCING LLMS TO DO AND REVEAL  (ALMOST) ANYTHING](others/jailbroken-how-does-llm-safety-training-fail/coercing-llms-to-do-and-reveal-almost-anything.md)
    * [Generating Valid and Natural Adversarial Examples  with Large Language Models](others/jailbroken-how-does-llm-safety-training-fail/generating-valid-and-natural-adversarial-examples-with-large-language-models.md)
    * [Stealthy and Persistent Unalignment on Large Language Models via  Backdoor Injections](others/jailbroken-how-does-llm-safety-training-fail/stealthy-and-persistent-unalignment-on-large-language-models-via-backdoor-injections-1.md)
    * [Scaling Laws for Adversarial Attacks on Language  Model Activations](others/jailbroken-how-does-llm-safety-training-fail/scaling-laws-for-adversarial-attacks-on-language-model-activations.md)
    * [Ignore Previous Prompt: Attack Techniques For Language Models](others/jailbroken-how-does-llm-safety-training-fail/ignore-previous-prompt-attack-techniques-for-language-models.md)
    * [ToolSword: Unveiling Safety Issues of Large Language Models in Tool Learning Across Three Stages](others/jailbroken-how-does-llm-safety-training-fail/toolsword-unveiling-safety-issues-of-large-language-models-in-tool-learning-across-three-stages.md)
    * [A New Era in LLM Security: Exploring Security Concerns in Real-World LLM-based Systems](others/jailbroken-how-does-llm-safety-training-fail/a-new-era-in-llm-security-exploring-security-concerns-in-real-world-llm-based-systems.md)
    * [ATTACKING LARGE LANGUAGE MODELS WITH PROJECTED GRADIENT DESCENT](others/jailbroken-how-does-llm-safety-training-fail/attacking-large-language-models-with-projected-gradient-descent.md)
    * [Soft Prompt Threats: Attacking Safety Alignment and Unlearning in Open-Source LLMs through the Embed](others/jailbroken-how-does-llm-safety-training-fail/soft-prompt-threats-attacking-safety-alignment-and-unlearning-in-open-source-llms-through-the-embed.md)
    * [Query-Based Adversarial Prompt Generation](others/jailbroken-how-does-llm-safety-training-fail/query-based-adversarial-prompt-generation.md)
    * [COERCING LLMS TO DO AND REVEAL (ALMOST) ANYTHING](others/jailbroken-how-does-llm-safety-training-fail/coercing-llms-to-do-and-reveal-almost-anything-1.md)
    * [Is LLM-as-a-Judge Robust? Investigating Universal Adversarial Attacks on Zero-shot LLM Assessment](others/jailbroken-how-does-llm-safety-training-fail/is-llm-as-a-judge-robust-investigating-universal-adversarial-attacks-on-zero-shot-llm-assessment.md)
    * [Fast Adversarial Attacks on Language Models In One GPU Minute](others/jailbroken-how-does-llm-safety-training-fail/fast-adversarial-attacks-on-language-models-in-one-gpu-minute.md)
    * [DrAttack: Prompt Decomposition and Reconstruction Makes Powerful LLM Jailbreakers](others/jailbroken-how-does-llm-safety-training-fail/drattack-prompt-decomposition-and-reconstruction-makes-powerful-llm-jailbreakers.md)
    * [From Noise to Clarity: Unraveling the Adversarial Suffix of Large Language Model Attacks via Transla](others/jailbroken-how-does-llm-safety-training-fail/from-noise-to-clarity-unraveling-the-adversarial-suffix-of-large-language-model-attacks-via-transla.md)
    * [Rainbow Teaming: Open-Ended Generation of Diverse Adversarial Prompts](others/jailbroken-how-does-llm-safety-training-fail/rainbow-teaming-open-ended-generation-of-diverse-adversarial-prompts.md)
    * [CodeChameleon: Personalized Encryption Framework for Jailbreaking Large Language Models](others/jailbroken-how-does-llm-safety-training-fail/codechameleon-personalized-encryption-framework-for-jailbreaking-large-language-models.md)
    * [Large Language Models are Vulnerable to Bait-and-Switch Attacks for Generating Harmful Content](others/jailbroken-how-does-llm-safety-training-fail/large-language-models-are-vulnerable-to-bait-and-switch-attacks-for-generating-harmful-content.md)
    * [Mitigating Fine-tuning Jailbreak Attack with Backdoor Enhanced Alignment](others/jailbroken-how-does-llm-safety-training-fail/mitigating-fine-tuning-jailbreak-attack-with-backdoor-enhanced-alignment.md)
    * [PRP: Propagating Universal Perturbations to Attack Large Language Model Guard-Rails](others/jailbroken-how-does-llm-safety-training-fail/prp-propagating-universal-perturbations-to-attack-large-language-model-guard-rails.md)
    * [A Cross-Language Investigation into Jailbreak Attacks in Large Language Models](others/jailbroken-how-does-llm-safety-training-fail/a-cross-language-investigation-into-jailbreak-attacks-in-large-language-models.md)
    * [DrAttack: Prompt Decomposition and Reconstruction Makes Powerful LLM Jailbreakers](others/jailbroken-how-does-llm-safety-training-fail/drattack-prompt-decomposition-and-reconstruction-makes-powerful-llm-jailbreakers-1.md)
    * [Attacking LLM Watermarks by Exploiting Their Strengths](others/jailbroken-how-does-llm-safety-training-fail/attacking-llm-watermarks-by-exploiting-their-strengths.md)
    * [From Noise to Clarity: Unraveling the Adversarial Suffix of Large Language Model Attacks via Transla](others/jailbroken-how-does-llm-safety-training-fail/from-noise-to-clarity-unraveling-the-adversarial-suffix-of-large-language-model-attacks-via-transl-1.md)
    * [DeepInception: Hypnotize Large Language Model to Be Jailbreaker](others/jailbroken-how-does-llm-safety-training-fail/deepinception-hypnotize-large-language-model-to-be-jailbreaker.md)
    * [Hijacking Large Language Models via Adversarial In-Context Learning](others/jailbroken-how-does-llm-safety-training-fail/hijacking-large-language-models-via-adversarial-in-context-learning.md)
    * [DeceptPrompt: Exploiting LLM-driven Code Generation via Adversarial Natural Language Instructions](others/jailbroken-how-does-llm-safety-training-fail/deceptprompt-exploiting-llm-driven-code-generation-via-adversarial-natural-language-instructions.md)
    * [Syntactic Ghost: An Imperceptible General-purpose Backdoor Attacks on Pre-trained Language Models](others/jailbroken-how-does-llm-safety-training-fail/syntactic-ghost-an-imperceptible-general-purpose-backdoor-attacks-on-pre-trained-language-models.md)
    * [Conversation Reconstruction Attack Against GPT Models](others/jailbroken-how-does-llm-safety-training-fail/conversation-reconstruction-attack-against-gpt-models.md)
    * [PoisonedRAG: Knowledge Poisoning Attacks to Retrieval-Augmented Generation of Large Language Models](others/jailbroken-how-does-llm-safety-training-fail/poisonedrag-knowledge-poisoning-attacks-to-retrieval-augmented-generation-of-large-language-models.md)
    * [COLD-Attack: Jailbreaking LLMs with Stealthiness and Controllability](others/jailbroken-how-does-llm-safety-training-fail/cold-attack-jailbreaking-llms-with-stealthiness-and-controllability.md)
    * [Play Guessing Game with LLM: Indirect Jailbreak Attack with Implicit](others/jailbroken-how-does-llm-safety-training-fail/play-guessing-game-with-llm-indirect-jailbreak-attack-with-implicit.md)
    * [Leveraging the Context through Multi-Round Interactions for Jailbreaking Attacks](others/jailbroken-how-does-llm-safety-training-fail/leveraging-the-context-through-multi-round-interactions-for-jailbreaking-attacks.md)
    * [Analyzing the Inherent Response Tendency of LLMs: Real-World Instructions-Driven Jailbreak](others/jailbroken-how-does-llm-safety-training-fail/analyzing-the-inherent-response-tendency-of-llms-real-world-instructions-driven-jailbreak.md)
    * [UNIVERSAL JAILBREAK BACKDOORS FROM POISONED HUMAN FEEDBACK](others/jailbroken-how-does-llm-safety-training-fail/universal-jailbreak-backdoors-from-poisoned-human-feedback.md)
    * [Cognitive Overload: Jailbreaking Large Language Models with Overloaded Logical Thinking](others/jailbroken-how-does-llm-safety-training-fail/cognitive-overload-jailbreaking-large-language-models-with-overloaded-logical-thinking.md)
    * [Scalable and Transferable Black-Box Jailbreaks for Language Models via Persona Modulation](others/jailbroken-how-does-llm-safety-training-fail/scalable-and-transferable-black-box-jailbreaks-for-language-models-via-persona-modulation.md)
    * [POISONPROMPT: BACKDOOR ATTACK ON PROMPT-BASED LARGE LANGUAGE MODELS](others/jailbroken-how-does-llm-safety-training-fail/poisonprompt-backdoor-attack-on-prompt-based-large-language-models.md)
    * [BACKDOORING INSTRUCTION-TUNED LARGE LANGUAGE MODELS WITH VIRTUAL PROMPT INJECTION](others/jailbroken-how-does-llm-safety-training-fail/backdooring-instruction-tuned-large-language-models-with-virtual-prompt-injection.md)
    * [Backdoor Attacks for In-Context Learning with Language Models](others/jailbroken-how-does-llm-safety-training-fail/backdoor-attacks-for-in-context-learning-with-language-models.md)
    * [Instructions as Backdoors: Backdoor Vulnerabilities of Instruction Tuning for Large Language Models](others/jailbroken-how-does-llm-safety-training-fail/instructions-as-backdoors-backdoor-vulnerabilities-of-instruction-tuning-for-large-language-models.md)
    * [UOR: Universal Backdoor Attacks on Pre-trained Language Models](others/jailbroken-how-does-llm-safety-training-fail/uor-universal-backdoor-attacks-on-pre-trained-language-models.md)
    * [Syntactic Ghost: An Imperceptible General-purpose Backdoor Attacks on Pre-trained Language Models](others/jailbroken-how-does-llm-safety-training-fail/syntactic-ghost-an-imperceptible-general-purpose-backdoor-attacks-on-pre-trained-language-models-1.md)
    * [Backdoor Activation Attack: Attack Large Language Models using Activation Steering for Safety-Alignm](others/jailbroken-how-does-llm-safety-training-fail/backdoor-activation-attack-attack-large-language-models-using-activation-steering-for-safety-alignm.md)
    * [Imperio: Language-Guided Backdoor Attacks for Arbitrary Model Control](others/jailbroken-how-does-llm-safety-training-fail/imperio-language-guided-backdoor-attacks-for-arbitrary-model-control.md)
    * [Large Language Models Are Better Adversaries: Exploring Generative Clean-Label Backdoor Attacks Agai](others/jailbroken-how-does-llm-safety-training-fail/large-language-models-are-better-adversaries-exploring-generative-clean-label-backdoor-attacks-agai.md)
    * [Universal Vulnerabilities in Large Language Models: Backdoor Attacks for In-context Learning](others/jailbroken-how-does-llm-safety-training-fail/universal-vulnerabilities-in-large-language-models-backdoor-attacks-for-in-context-learning.md)
    * [BADCHAIN: BACKDOOR CHAIN-OF-THOUGHT PROMPTING FOR LARGE LANGUAGE MODELS](others/jailbroken-how-does-llm-safety-training-fail/badchain-backdoor-chain-of-thought-prompting-for-large-language-models.md)
    * [AUTODAN: INTERPRETABLE GRADIENT-BASED ADVERSARIAL ATTACKS ON LARGE LANGUAGE MODELS](others/jailbroken-how-does-llm-safety-training-fail/autodan-interpretable-gradient-based-adversarial-attacks-on-large-language-models.md)
    * [AN LLM CAN FOOL ITSELF: A PROMPT-BASED ADVERSARIAL ATTACK](others/jailbroken-how-does-llm-safety-training-fail/an-llm-can-fool-itself-a-prompt-based-adversarial-attack.md)
    * [AUTOMATIC HALLUCINATION ASSESSMENT FOR ALIGNED LARGE LANGUAGE MODELS VIA TRANSFERABLE ADVERSARIAL AT](others/jailbroken-how-does-llm-safety-training-fail/automatic-hallucination-assessment-for-aligned-large-language-models-via-transferable-adversarial-at.md)
    * [LLM LIES: HALLUCINATIONS ARE NOT BUGS, BUT FEATURES AS ADVERSARIAL EXAMPLES](others/jailbroken-how-does-llm-safety-training-fail/llm-lies-hallucinations-are-not-bugs-but-features-as-adversarial-examples.md)
    * [LOFT: LOCAL PROXY FINE-TUNING FOR IMPROVING TRANSFERABILITY OF ADVERSARIAL ATTACKS AGAINST LARGE LAN](others/jailbroken-how-does-llm-safety-training-fail/loft-local-proxy-fine-tuning-for-improving-transferability-of-adversarial-attacks-against-large-lan.md)
    * [Universal and Transferable Adversarial Attacks on Aligned Language Models](others/jailbroken-how-does-llm-safety-training-fail/universal-and-transferable-adversarial-attacks-on-aligned-language-models-1.md)
    * [Robustness Over Time: Understanding Adversarial Examples’ Effectiveness on Longitudinal Versions of](others/jailbroken-how-does-llm-safety-training-fail/robustness-over-time-understanding-adversarial-examples-effectiveness-on-longitudinal-versions-of.md)
    * [BASELINE DEFENSES FOR ADVERSARIAL ATTACKS AGAINST ALIGNED LANGUAGE MODELS](others/jailbroken-how-does-llm-safety-training-fail/baseline-defenses-for-adversarial-attacks-against-aligned-language-models.md)
    * [Speak Out of Turn: Safety Vulnerability of Large Language Models in Multi-turn Dialogue](others/jailbroken-how-does-llm-safety-training-fail/speak-out-of-turn-safety-vulnerability-of-large-language-models-in-multi-turn-dialogue.md)
    * [Making Them Ask and Answer: Jailbreaking Large Language Models in Few Queries via Disguise and Recon](others/jailbroken-how-does-llm-safety-training-fail/making-them-ask-and-answer-jailbreaking-large-language-models-in-few-queries-via-disguise-and-recon.md)
    * [Adversarial Demonstration Attacks on Large Language Models](others/jailbroken-how-does-llm-safety-training-fail/adversarial-demonstration-attacks-on-large-language-models.md)
    * [COVER: A Heuristic Greedy Adversarial Attack on Prompt-based Learning in Language Models](others/jailbroken-how-does-llm-safety-training-fail/cover-a-heuristic-greedy-adversarial-attack-on-prompt-based-learning-in-language-models.md)
    * [The Butterfly Effect of Altering Prompts: How Small Changes and Jailbreaks Affect Large Language Mod](others/jailbroken-how-does-llm-safety-training-fail/the-butterfly-effect-of-altering-prompts-how-small-changes-and-jailbreaks-affect-large-language-mod.md)
    * [Open the Pandora’s Box of LLMs: Jailbreaking LLMs through Representation Engineering](others/jailbroken-how-does-llm-safety-training-fail/open-the-pandoras-box-of-llms-jailbreaking-llms-through-representation-engineering.md)
    * [How Johnny Can Persuade LLMs to Jailbreak Them: Rethinking Persuasion to Challenge AI Safety by Huma](others/jailbroken-how-does-llm-safety-training-fail/how-johnny-can-persuade-llms-to-jailbreak-them-rethinking-persuasion-to-challenge-ai-safety-by-huma.md)
    * [Sowing the Wind, Reaping the Whirlwind: The Impact of Editing Language Models](others/jailbroken-how-does-llm-safety-training-fail/sowing-the-wind-reaping-the-whirlwind-the-impact-of-editing-language-models.md)
    * [PANDORA: Jailbreak GPTs by Retrieval Augmented Generation Poisoning](others/jailbroken-how-does-llm-safety-training-fail/pandora-jailbreak-gpts-by-retrieval-augmented-generation-poisoning.md)
    * [Weak-to-Strong Jailbreaking on Large Language Models](others/jailbroken-how-does-llm-safety-training-fail/weak-to-strong-jailbreaking-on-large-language-models-1.md)
    * [Jailbreaking Proprietary Large Language Models using Word Substitution Cipher](others/jailbroken-how-does-llm-safety-training-fail/jailbreaking-proprietary-large-language-models-using-word-substitution-cipher.md)
    * [Semantic Mirror Jailbreak: Genetic Algorithm Based Jailbreak Prompts Against Open-source LLMs](others/jailbroken-how-does-llm-safety-training-fail/semantic-mirror-jailbreak-genetic-algorithm-based-jailbreak-prompts-against-open-source-llms.md)
